...
document.addEventListener('DOMContentLoaded', function () {
  function filtrarUsuarios() {
      const input = document.getElementById('pesquisarSubCategoria');
      const filtro = input.value.toLowerCase();
      const tabela = document.getElementById('CE_SubCategoria');
  ...
  const inputPesquisar = document.getElementById('pesquisarSubCategoria');
