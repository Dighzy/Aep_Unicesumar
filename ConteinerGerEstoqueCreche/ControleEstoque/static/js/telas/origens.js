...
document.addEventListener('DOMContentLoaded', function () {
  function filtrarUsuarios() {
      const input = document.getElementById('pesquisarOrigens');
      const filtro = input.value.toLowerCase();
      const tabela = document.getElementById('origensLancamento');
  ...
  const inputPesquisar = document.getElementById('pesquisarOrigens');
